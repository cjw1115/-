        ...
        pgwMenu.checkMenu = function() {
            ...
            function switchMenu(type) {
                if (type == 'viewmore') {
                    ...
                    pgwMenu.plugin.find('.pm-links > li > a').css("transform","skew(0)");
                    pgwMenu.plugin.find('.pm-links').addClass('mobile').hide();
                    pgwMenu.plugin.find('.pm-viewMore, .pm-viewMore > ul').hide();
                    pgwMenu.plugin.find('.pm-viewMore > ul > li').remove();
                    pgwMenu.plugin.find('.pm-links > ul > li > a').css("transform","skew(0)");
                    pgwMenu.plugin.find('.pm-dropDown').show();

                } else {
                    pgwMenu.plugin.find('.pm-links > li').show();
                    pgwMenu.plugin.find('.pm-links > li > a').css("transform","skew(15deg)");
                    // pgwMenu.plugin.find('.pm-links').removeClass('mobile').show();
                    pgwMenu.plugin.find('.pm-links').removeClass('mobile').css("display","inline-block");
            ...
            if($(window).width()>getContentWidth()+200){
                switchMenu('normal');
            }else{
                switchMenu('dropdown');
            }
